/*==============================
    ...
    /*====================================
        cart-drawer js
    ====================================*/
    $(document).on("click", ".cart-wrapper a.js-cart-drawer, .bottom-menu-wrapper a.bottom-menu-cart, a.add-to-cart, .bottom-menu-cart", function() {
    $("#cart-drawer").addClass('active');
    $(".bg-screen").addClass('active');
    $("body").addClass('hidden');
});
$(document).on("click", ".drawer-close button.drawer-close-btn", function() {
    ...
    /*====================================
        bg-screen js
    ====================================*/
    $(document).on("click", ".bg-screen", function() {
   ...
   /*====================================
    ...
    var swiper = new Swiper('.swiper#cat-slider8', {
     ...
     /*====================================
       home-1 product  js
    ====================================*/
    document.querySelectorAll('.collection-slider.swiper[id^="trending-"]').forEach(function (el) {
    var subcatId = el.id.replace('trending-', '');
    ...
    new Swiper(el, {
        ...
        watchSlidesProgress: true,
        navigation: {
            prevEl: '.swiper-prev-' + subcatId,
            nextEl: '.swiper-next-' + subcatId
        },
        pagination: {
            el: '.swiper-pagination-' + subcatId,
            clickable: true
        },
        autoplay: false,
        breakpoints: {
            ...
            1499: { slidesPerView: 4, spaceBetween: 30 }
        }
    });
});

// Featured-product wala static rehne diya (agar aap kahin aur use kar rahe ho)
...
// ========== FORCE CLOSE MOBILE MENU & VEGA MENU ==========
$(document).ready(function () {

    // Mobile Menu Close
    $(document).on('click', '.menu-close-btn, .menu-close button, .menu-close', function (e) {
        e.preventDefault();
        e.stopPropagation();

        $('#mobile-menu').removeClass('active');
        $('.main-menu-area, .header-bottom').removeClass('active');
        $('.bg-screen').removeClass('active');
        $('body').removeClass('hidden');
    });

    // Vega Menu Close
    $(document).on('click', '.vega-close-btn, .vega-close button, .vega-close', function (e) {
        e.preventDefault();
        e.stopPropagation();
